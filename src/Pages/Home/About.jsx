...
export default function About() {
  return (
    <div class=" py-35 overflow-hidden bg-[#353535]">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="grid lg:grid-cols-2 items-center gap-16 justify-center">
          <div>
            <img
              src={about}
              class="sm:h-full sm:w-full object-contain rounded-lg opacity-80"
            />
          </div>
