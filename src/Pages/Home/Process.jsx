  ...
  return (
    <div class="bg-[#161616] py-20 border-t border-[#2f2f2f]/40">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class-="max-w-5xl ">
          <h2
            class="text-[#e0e1e6] text-xl font-semibold mb-5"
            data-aos="fade-left"
          >
            Our Process
          </h2>
          ...
          <div className="grid gap-12 lg:grid-cols-5">
            {steps.map((step) => (
              ...
              >
                {/* Circle */}
                <div
                  className="relative z-10 flex h-16 w-16 items-center justify-center rounded-full bg-[#F22233] border-4 border-[#242424] text-xl font-bold text-white shadow-lg"
                  data-aos="fade-down"
                >
                  {step.number}
                </div>
                ...
                {/* Card */}
                <div
                  className="mt-6 w-full rounded-xl bg-[#303030] p-6 shadow-lg transition duration-300 hover:-translate-y-2 hover:shadow-2xl"
                  data-aos="fade-down"
                >
